 ...
 */
export declare class ErrMissingValue extends Err {
 ...
 */
export declare class ErrStructureTyping extends Err {
    constructor(reason: string);
}
/**
 * Signals an unknown type.
 */
export declare class ErrUnknownType extends ErrTypingSystem {
